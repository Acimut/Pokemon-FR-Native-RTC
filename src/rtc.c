...
extern struct SiiRtcInfo sRtc;  // IWRAM [0xC bytes] /align  0x030074f0;
extern u8 sProbeResult;         // IWRAM [1 bytes]   /align  0x030074fc;
extern u16 sSavedIme;           // IWRAM [2 bytes]           0x030074fe;
