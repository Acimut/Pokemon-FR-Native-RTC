...
extern vu16 GPIOPortDirection;  //080000c6 g 00000000 GPIOPortDirection

//static u16 sDummy; // unused variable       Usar bytes libres en la IWRAM [2 bytes] /align
//static bool8 sLocked;   // iwram bss ???    Usar bytes libres en la IWRAM [1 bytes]
extern u16 sDummy; // unused variable   //0x030074e0;
extern bool8 sLocked;                   //0x030074e2;
